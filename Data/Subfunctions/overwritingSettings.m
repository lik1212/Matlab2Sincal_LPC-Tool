...
if isfield(Inputs,'Output_option_del_temp_files'        ); Settings.del_sim_files       = Inputs.Output_option_del_temp_files       ; end
if isfield(Inputs,'Output_option_del_temp_files_begin'  ); Settings.del_sim_files_begin = Inputs.Output_option_del_temp_files_begin ; end
if isfield(Inputs,'Output_option_preparation'           ); Settings.output_prepare      = Inputs.Output_option_preparation          ; end
...
if isfield(Inputs,'LP_Path'                             ); Settings.LP_Path             = Inputs.LP_Path                            ; end
if isfield(Inputs,'PV_Path'                             ); Settings.PV_Path             = Inputs.PV_Path                            ; end
