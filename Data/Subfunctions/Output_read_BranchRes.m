...
if Settings.Output_option_raw_only || Settings.Output_option_raw
    SimData_Filename = [Path_Output, SinNameBasic, '_BranchRes_raw_', Settings.ResultsSuffix, '.mat'];
...
if Settings.Output_option_per_unit
    SimData_Filename_ID_up = [Path_Output, SinNameBasic, '_BranchRes_per_units_ID_up_', Settings.ResultsSuffix, '.mat'];
    ...
    SimData_Filename_ID_down = [Path_Output, SinNameBasic, '_BranchRes_per_units_ID_down_', Settings.ResultsSuffix, '.mat'];
...
if Settings.Output_option_per_node_branch
    SimData_Filename = [Path_Output, SinNameBasic, '_BranchRes_per_branches_', Settings.ResultsSuffix, '.mat'];
