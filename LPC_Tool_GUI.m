...
f.Main_Win.radiobutton_input_dist_LP_mean = ...                 % TODO: No function yet!
    uicontrol(f.Main_Win.uibuttongroup_input_LP_dist    ,...
    'Style'             , 'radiobutton'                 ,...
    'Units'             , 'normalized'                  ,...
    'Backgroundcolor'   , f.Main_Win.figure.Color       ,...
...
if f.Main_Win.radiobutton_input_dist_LP_list.Value == 1 % || f.Main_Win.radiobutton_input_dist_LP_mean.Value == 1 (TODO)
...
output_checkbox = {...
    ...
    'checkbox_output_data_selection_Sin_Info'           ,...
    };
