...
if ishandle(findobj('type','figure','Tag','PLC_Tool'))
    figure(findobj('type','figure','Tag','PLC_Tool'))
    return
end
...
f.Main_Win.text_Title = ...
    ...
    'style',            'text',...
    'Units',            'normalized',...
    'Position',         [0.3 0.99-0.03-40/663 0.4 0.05],...
...
f.Main_Win.edit_dist_list_LP_path = ...
    ...
    'Units',            'normalized',...
    'Position',         [0.32 0.1 0.66 0.35],...
    'String',           [f.Inputs.LP_dist_path,f.Inputs.LP_dist_list_name],...
    'Value',            1,...
    'BackgroundColor',  [1 1 1],...
    'FontUnits',        'pixels',...
    'FontSize',         12....
...
f.Main_Win.edit_dist_list_PV_path = ...
    ...
    'Units',            'normalized',...
    'Position',         [0.32 0.1 0.66 0.35],...
    'String',           [f.Inputs.PV_dist_path,f.Inputs.PV_dist_list_name],...
    'Value',            1,...
    'BackgroundColor',  [1 1 1],...
    'FontUnits',        'pixels',...
    'FontSize',         12....
